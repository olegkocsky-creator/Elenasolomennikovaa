...
function generateReviews() {
  // Убираем проверку на папку books, так как все файлы в корне
  const reviewsSection = document.querySelector('.reviews-section');
  if (!reviewsSection) return;
  
  // Получаем имя файла из текущего URL
  const currentFile = window.location.pathname.split('/').pop() || window.location.href.split('/').pop();
  const bookId = currentFile ? currentFile.split('.')[0] : '';
  
  // Проверяем, есть ли файл (может быть index.html или главная страница)
  if (!bookId || bookId === 'index') return;
  
  console.log('Generating reviews for:', bookId);
  ...
  const allReviews = {
    ...
    '3a-porosenok': [
      ...
      },
      {
        ...
        date: "25.12.2023",
        rating: 5,
        text: "Потрясающая история о силе детской любви и верности."
      }
    ],
    '3b-yolka': [
      {
      ...
      },
      {
        ...
        date: "28.12.2023",
        rating: 4,
        text: "Пронзительная история о надежде в самые темные времена."
      }
    ],
    '4-tumi': [
      {
      ...
      },
      {
        ...
        date: "15.12.2023",
        rating: 5,
        text: "Книга, которая заставляет поверить в чудеса даже самого скептичного человека."
      }
    ],
    '5-snezhoviki': [
      {
      ...
      },
      {
        ...
        date: "30.12.2023",
        rating: 4,
        text: "Волшебная история, которая напоминает о красоте мимолётных мгновений."
      }
    ],
    '6-zimnyaya-istoriya': [
      {
      ...
      },
      {
        ...
        date: "10.12.2023",
        rating: 5,
        text: "Джилл Барклем создала настоящую зимнюю сказку. Иллюстрации восхитительны!"
      }
    ],
    '7-chai-v-lesu': [
      {
      ...
      },
      {
        ...
        date: "20.12.2023",
        rating: 5,
        text: "Японская эстетика в каждом слове. Книга-терапия для души."
      }
    ],
    '9-lyuter': [
      {
      ...
      },
      {
        ...
        date: "25.12.2023",
        rating: 4,
        text: "Трогательная история о том, как маленький герой совершает большое дело."
      }
    ]
  };
  ...
  // Запускаем анимацию для новых карточек отзывов
  setTimeout(() => {
